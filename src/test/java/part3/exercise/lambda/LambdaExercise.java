...
public class LambdaExercise {
    ...
    public void function() {
        final Function<Person, String>
            getPersonName1 =
            name -> name.getFirstName(); // TODO get the name of person using expression lambda
        ...
        final Function<Person, String> getPersonNameAndLogIt = name -> {
