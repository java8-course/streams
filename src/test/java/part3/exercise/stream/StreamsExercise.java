...
public class StreamsExercise {
    ...
    public void getAllJobHistoryEntries() {
        ...
        final List<JobHistoryEntry> jobHistoryEntries = employees.stream()
                .flatMap(e -> e.getJobHistory().stream()).collect(Collectors.toList());
    ...
    public void getSumDuration() {
        ...
        final int sumDurations = employees.stream().flatMap(e -> e.getJobHistory().stream())
    ...
    public void indexPersonsByEmployer1() {
        ...
        final Map<String, List<PersonEmployer>> index = employees.stream()
                .flatMap(e -> e.getJobHistory().stream()
                        .map(d -> new PersonEmployer(e.getPerson(), d.getEmployer())))
    ...
    public void getSumPersonDuration() {
        ...
        final Map<Person, Integer> personDuration = employees
                .stream().map(this::sumAllPersonDurations)
        ...
        final List<PersonPositionDuration> personPositionDurations = employees.stream()
                .flatMap(e -> e.getJobHistory().stream()
                        ...
                        .collect(Collectors.toMap(PersonPositionDuration::getPosition, Function.identity(),
                                (PersonPositionDuration ppd1, PersonPositionDuration ppd2) ->
                                        new PersonPositionDuration(ppd1.getPerson(), ppd1.getPosition(),
                                                ppd1.getDuration() + ppd2.getDuration()))).entrySet().stream()
    ...
    public void getCoolestPersonByPosition2() {
        ...
        final Map<String, Person> coolestPersonByPosition = employees.stream()
                ...
                .collect(Collectors.toMap(Map.Entry::getKey, e -> e.getValue().getPerson()));
