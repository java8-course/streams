...
public class StreamsExercise {
        ...
        final Map<String, List<PersonEmployer>> index =
                employees.stream()
                        .flatMap(p -> p.getJobHistory().stream()
                                ...
                                .map((e) -> new PersonEmployer(p.getPerson(), e)))
                        .collect(groupingBy(PersonEmployer::getEmployer, toList())); // TODO
    ...
    public void getSumPersonDuration() {
        ...
        final Map<Person, Integer> personDuration = employees.stream()
                ...
                .collect(toMap(PersonDuration::getPerson, PersonDuration::getDuration)); // TODO use sumAllPersonDurations
