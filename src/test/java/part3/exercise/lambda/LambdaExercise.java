...
public class LambdaExercise {
    ...
    public void function() {
        ...
        final Function<Person, String> getPersonName2 = Person::getLastName;
        final Function<Person, String> getPersonNameAndLogIt = p -> {
            final String age = String.valueOf(p.getAge());
    ...
    public void combineFunctions() {
        ...
        final Function<Person, Integer> getPersonNameLength2 = p -> p.getLastName().length();
    ...
    public void methodReference() {
        ...
        combine(Person::getFirstName, "John"::equals).test(person);
