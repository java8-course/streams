...
public class LambdaExercise {
    ...
    public void function() {
        final Function<Person, String> getPersonName1 = t->t.getFirstName();

        final Function<Person, String> getPersonName2 = Person::getFirstName;

        final Function<Person, String> getPersonNameAndLogIt = t->{
    ...
    public void combineFunctions() {
        final Function<Person, String> getPersonName = t->t.getFirstName();

        assertEquals("John", getPersonName.apply(new Person("John", "Galt", 30)));

        final Function<String, Integer> getStringLength = t->t.length();

        assertEquals(Integer.valueOf(3), getStringLength.apply("ABC"));

        final Function<Person, Integer> getPersonNameLength1 = t->getStringLength.apply(getPersonName.apply(t));
    ...
    public void methodReference() {
        ...
        final Predicate<String> isJohnString = t->t.equals("John");
