...
public class StreamsExercise {
    ...
    private static class PersonEmployer {
        ...
        public PersonEmployer(final Person person, final String employer) {
            this.person = person;
    ...
    private PersonDuration sumAllPersonDurations(final Employee e) {
        return new PersonDuration(e.getPerson(), e.getJobHistory().stream().mapToInt(JobHistoryEntry::getDuration).sum());
    }
                ...
                e.getJobHistory()
                        ...
                        .collect(Collectors
                                .groupingBy(
                                        ...
                                        collectingAndThen(summingInt(JobHistoryEntry::getDuration), Integer::intValue))));
    }
    ...
    public void getDurationsForEachPersonByPosition() {
        ...
        final List<PersonPositionDuration> personPositionDurations = employees
                .stream()
                .map(StreamsExercise::getPersonPositionIndex)
                .flatMap(e -> e.getDurationByPositionIndex()
                        .entrySet()
                        .stream()
        ...
        final Map<String, Person> coolestPersonByPosition = employees
                ...
                .collect(
                        groupingBy(
                                ...
                                collectingAndThen(
                                        maxBy(comparingInt(PersonPositionDuration::getDuration)),
                                        l -> l.get().getPerson()
                                )
                        ));
