...
public class StreamsExercise {
    ...
    public void indexPersonsByEmployer1() {
        ...
        final Map<String, List<PersonEmployer>> index = getPersonEmployerStream(employees)
                .collect(groupingBy(PersonEmployer::getEmployer));
        assertEquals(11, index.get("epam").size());
    }

    private static Stream<PersonEmployer> getPersonEmployerStream(List<Employee> employees) {
        return employees.stream()
                .flatMap(e -> e.getJobHistory().stream()
                        .map(t -> new PersonEmployer(e.getPerson(), t.getEmployer())));
    }
    ...
    public void indexPersonsByEmployer2() {
        ...
        final Map<String, List<Person>> index = getPersonEmployerStream(employees)
                .collect(groupingBy(PersonEmployer::getEmployer,
    ...
    public void getSumPersonDuration() {
        ...
        final Map<Person, Integer> personDuration = employees.stream()
                ...
                .collect(toMap(PersonDuration::getPerson,
    ...
    public void getDurationsForEachPersonByPosition() {
        ...
        final List<PersonPositionDuration> personPositionDurations = getPersonPositionDurationStream(employees)
                .collect(toList());
        ...
        final Map<String, Person> coolestPersonByPosition =
                getPersonPositionDurationStream(employees)
                        .collect(groupingBy(PersonPositionDuration::getPosition,
                                collectingAndThen(Collectors.maxBy(comparingInt(PersonPositionDuration::getDuration)),
                                        o -> o.get().getPerson())));
