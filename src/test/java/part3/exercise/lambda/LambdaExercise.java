...
public class LambdaExercise {
    ...
    public void function() {
        final Function<Person, String> getPersonName1 = person1 -> person1.getFirstName();

        final Function<Person, String> getPersonName2 = Person::getFirstName;

        final Function<Person, String> getPersonNameAndLogIt = person1 -> {
    ...
    public void combineFunctions() {
        ...
        final Function<Person, Integer> getPersonNameLength1 = person1 -> {
            String apply = getPersonName.apply(person1);
            return getStringLength.apply(apply);
        };
